...
public class BetaLoadMem extends AsyncTask<String, Integer, String>
{
    ...
    public BetaLoadMem(Context context) {
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ urlref.libbetamem);
