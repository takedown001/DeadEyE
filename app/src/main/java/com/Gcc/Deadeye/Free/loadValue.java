...
public class loadValue extends AsyncTask<String, Integer, String>
{
    ...
    public loadValue(Context context) {
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ "/libsys.so");
