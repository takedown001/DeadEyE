package com.Gcc.Deadeye.GccConfig;
...
public class urlref {
    ...
    public static final String TAG_SUCCESS = "9";
    public static final String TAG_ERROR = "7";
...
//Download Center
    ...
    public static final String libmem = "/libPNR.so";
    public static final String libbetamem = "/libCNR.so";
