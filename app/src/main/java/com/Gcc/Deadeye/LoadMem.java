...
public class LoadMem extends AsyncTask<String, Integer, String>
{
    ...
    public LoadMem(Context context) {
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ urlref.libmem);
