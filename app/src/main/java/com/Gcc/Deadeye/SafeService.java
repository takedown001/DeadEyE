                    ...
                    public void onMenuSelected(int index) {
                        if(index==0) {
                            if (less) {
                                ...
                                Toast.makeText(getApplicationContext(), "Recoil Compensation Activated " , Toast.LENGTH_SHORT).show();
                                less=false;
                            } else {
                                ShellUtils.SU(myDaemon + " LESSBAND");
                                Toast.makeText(getApplicationContext(), "Recoil Compensation Deactivated ", Toast.LENGTH_SHORT).show();
                                less=true;
                            }
                        }
                        else if (index == 1) {
                            if (aim) {
                                ...
                                Toast.makeText(getApplicationContext(), "Smooth Aimbot Activated ", Toast.LENGTH_SHORT).show();
                                aim=false;
                            } else {
                                SettingValue(101,true);
                            ...
                            if (cross) {
                                ...
                                Toast.makeText(getApplicationContext(), "Anti Bullet Spread Activated ", Toast.LENGTH_SHORT).show();
                                cross=false;
                            } else {
                                ShellUtils.SU(myDaemon + " CROSSBAND");
                                Toast.makeText(getApplicationContext(), "Anti Bullet Spread Deactivated " , Toast.LENGTH_SHORT).show();
                                cross=true;
                            }
                        }
                        else if (index == 3) {
                            if (magic) {
                                ...
                                Toast.makeText(getApplicationContext(), "Bullet Tracking Activated " , Toast.LENGTH_SHORT).show();
                                magic=false;
                            } else {
                                ShellUtils.SU(myDaemon + " BULLETBAND");
                                Toast.makeText(getApplicationContext(), "Bullet Tracking Deactivated " , Toast.LENGTH_SHORT).show();
                                magic=true;
                            }
                        }
                        else if (index == 4) {
                            if (head) {
                                ...
                                Toast.makeText(getApplicationContext(), "Headbot Activated " , Toast.LENGTH_SHORT).show();
                                head=false;
                            } else {
                                ShellUtils.SU(myDaemon + " HEADBAND");
                                Toast.makeText(getApplicationContext(), "Headbot Deactivated" , Toast.LENGTH_SHORT).show();
                                head=true;
                            }
                        }
