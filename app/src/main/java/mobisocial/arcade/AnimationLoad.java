...
public class AnimationLoad extends AsyncTask<String, Integer, String>
{
...
//        mProgressDialog.setCancelable(false);
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getExternalFilesDir(DIRECTORY_PICTURES).getAbsolutePath()+"/animation.zip");
