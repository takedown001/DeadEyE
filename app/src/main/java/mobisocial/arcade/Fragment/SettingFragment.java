            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        outputStream.writeBytes("rm -rf /sdcard/Android/data/com.*/cache\n" +
                                ...
                                "if [ $(pidof gameName) ]; then\n" +
                                "  rm -rf /data/system/graphicsstats/*/gameName\n" +
                                "  rm -rf /data/user_de/0/com.tencent.*\n" +
                                "  rm -rf /data/data/gameName/app_*\n" +
                                "  rm -rf /config/sdcardfs/com.tencent.*\n" +
                                "  rm -rf /storage/emulated/0/.backups\n" +
                                "  rm -rf /storage/emulated/0/tencent\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Logs\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/TGPA\n" +
                                "  rm -rf '/storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/Epic Games'\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate/SaveGames\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/LightData\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs0\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferEifs1\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/PufferTmpDir\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/SaveGames/UIElemLayout_*\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/*.json\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/*.flist\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/*.res\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/puffer*\n" +
                                "  rm -rf /storage/emulated/0/Android/data/gameName/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Saved/Paks/Puffer*\n" +
