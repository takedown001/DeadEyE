...
public class JSONParserString {
    ...
    public String makeHttpRequest(String url,JSONObject params) throws Exception {
        ...
        token.put("Data", Helper.encrypt(params.toString(), publickey));
        token.put("Hash", Helper.SHA256(params.toString()));
        CertificateFactory cf = CertificateFactory.getInstance("X.509");
        Certificate ca = cf.generateCertificate(new ByteArrayInputStream(certficate));
