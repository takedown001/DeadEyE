...
public class MemLoad extends AsyncTask<String, Integer, String>
{
    ...
    public MemLoad(Context context) {
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ urlref.SafeMem);
