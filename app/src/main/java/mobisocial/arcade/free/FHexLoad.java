...
public class FHexLoad extends AsyncTask<String, Integer, String>
{
    ...
    public FHexLoad(Context context) {
...
//        mProgressDialog.setCancelable(false);
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ urlref.FreeHexMem);
