package mobisocial.arcade.freebgmi;
...
import mobisocial.arcade.free.FSettingFragment;
import mobisocial.arcade.free.HomeFreeFragment;
...
public class BHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onItemSelected(int i) {
                ...
                switch (i) {
                    ...
                    case R.id.logout:
                        ...
                        finish();
                        Toast.makeText(BHomeActivity.this, "Logged Out Successfully!", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(BHomeActivity.this, FLoginActivity.class));
                        break;
                }
        ...
        if (Helper.checkVPN(BHomeActivity.this)) {
            Toast.makeText(BHomeActivity.this, "Turn Off Your Vpn", Toast.LENGTH_LONG).show();
            finish();
        } else {
    ...
    private void Check() throws PackageManager.NameNotFoundException, NoSuchAlgorithmException {
        if (imgLoad.Load(BHomeActivity.this).equals(time)) {
            finish();
...
//                    break;
                case R.id.ExtentUpgrade:
                    ...
                    return true;
                case R.id.Reseller:
                    Intent p = new Intent(BHomeActivity.this, ResellerActivity.class);
                    startActivity(p);
                    return true;
    ...
    class OneLoadAllProducts extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            String s = null;
            try {
                params.put(TAG_DEVICEID,Helper.getDeviceId(BHomeActivity.this));
        ...
        protected void onPostExecute(String s) {
            ...
            if (s == null || s.isEmpty()) {
                Toast.makeText(BHomeActivity.this, "Server Error", Toast.LENGTH_LONG).show();
                return ;
            }
                ...
                public void run() {
                    try {
                        ...
                        if (!Helper.verify(decData, ack.get("Sign").toString(), JSONParserString.publickey)) {
                            Toast.makeText(BHomeActivity.this, "Something Went Wrong", Toast.LENGTH_LONG).show();
                            return;
                        } else {
...
//                            Log.d("test",shred.getString(TAG_KEY,"null"));
                            if (error || shred.getString(TAG_KEY,"null").equals("null")) {
                                startActivity(new Intent(BHomeActivity.this, GameActivity.class));
                                Toast.makeText(BHomeActivity.this ,"Integrity Check Failed",Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (Float.parseFloat(version) < Float.parseFloat(newversion)) {
                                Intent intent = new Intent(BHomeActivity.this, AppUpdaterActivity.class);
                                ...
                                Intent intent = new Intent(BHomeActivity.this, activityMaintain.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                startActivity(intent);
                            }
                        }
