...
public class LiteHexLoad extends AsyncTask<String, Integer, String>
{
    ...
    public LiteHexLoad(Context context) {
    ...
    protected String doInBackground(String... url_download)
    {
        ...
        try {
            ...
            output = new FileOutputStream(instance.getFilesDir().toString()+ urlref.LiteMem);
